...
//                Optional<AttendanceDto> optionalAttendanceDto = attendantService.getRawAttendanceByDateAndUser(startDate.atTime(LocalTime.MIN), startDate.atTime(LocalTime.MAX), username);
//                if (optionalAttendanceDto.isPresent()) {
//                    records.add(optionalAttendanceDto.get());
//                }
//                startDate = startDate.plusDays(1);
//            }
//            records.add(rawAttendanceRepository.findPersonalDayAttendance(endDate.atTime(LocalTime.MIN), endDate.atTime(LocalTime.MAX), username));
//
//        } else {
//            while (startDate.isBefore(endDate)) {
